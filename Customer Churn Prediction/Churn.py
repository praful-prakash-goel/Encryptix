...
with open("C:/Users/prafu/Python/Projects/Customer Churn Prediction/grad_booster.pkl", "rb") as f:
    model = pickle.load(f)

with open("C:/Users/prafu/Python/Projects/Customer Churn Prediction/scaler.pkl", "rb") as f:
...
if user_report:
    st.image("C:/Users/prafu/Python/Projects/Customer Churn Prediction/Classification_report.png", caption="Classification Report")